...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cu0kp6wfj1ve.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'kayretlifatihblog' # please enter your s3 bucket name
